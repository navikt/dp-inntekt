...
internal class KlassifiserPosteringTest {
    ...
    fun `Klassifiser arbeidsinntekt `() {
        ...
        val klasseCount =
            klassifisertInntekt.inntektsListe
    ...
    fun `Klassifiser dagpenger for fangst og fiske - enabled hyreendring`() {
        val dagpengerFangstFiskePosteringer =
            listOf(
    ...
    fun `Klassifiser sykepenger for fangst og fiske - enabled hyreendring`() {
        val sykepengerFangstFiskePosteringer =
            listOf(
