...
private fun isOpplæringspenger(posteringsType: PosteringsType): Boolean {
    val opplæringspengerPosteringsTyper =
        listOf(
...
private fun isPleiepenger(posteringsType: PosteringsType): Boolean {
    val pleiepengerPosteringsTyper =
        listOf(
...
private fun isOmsorgspenger(posteringsType: PosteringsType): Boolean {
    val omsorgspengerPosteringsTyper =
        listOf(
...
private fun isFangstFiske(posteringsType: PosteringsType): Boolean {
    val fangstFiskePosteringsTyper =
        listOf(
...
private fun isDagpengerFangstFiske(posteringsType: PosteringsType): Boolean {
    val dagpengerFangstFiskePosteringsTyper =
        listOf(
...
private fun isSykepengerFangstFiske(posteringsType: PosteringsType): Boolean {
    val sykepengerFangstFiskePosteringsTyper =
        listOf(
...
private fun isTiltakslønn(posteringsType: PosteringsType): Boolean {
    val tiltakslønnPosteringsTyper =
        listOf(
