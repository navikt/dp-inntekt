...
val dataGrunnlagKlassifiseringToVerdikode =
    biMapOf(
        ...
        DatagrunnlagKlassifisering(InntektType.LOENNSINNTEKT, InntektBeskrivelse.TREKK_I_LOENN_FOR_FERIE, SpesielleInntjeningsforhold.HYRE_TIL_MANNSKAP_PAA_FISKE_SMAAHVALFANGST_OG_SELFANGSTFARTOEY) to "Hyre - Trekk i lønn for ferie",
        ...
        DatagrunnlagKlassifisering(InntektType.LOENNSINNTEKT, InntektBeskrivelse.SKATTEPLIKTIG_GODTGJOERELSE_SAERAVTALE_UTLAND, null) to "Skattepliktig godtgjørelse særavtale utland",
        ...
        DatagrunnlagKlassifisering(InntektType.LOENNSINNTEKT, InntektBeskrivelse.TREKK_I_LOENN_FOR_FERIE, SpesielleInntjeningsforhold.LOENN_VED_ARBEIDSMARKEDSTILTAK) to "Tiltak - Trekk i lønn for ferie",
        ...
        DatagrunnlagKlassifisering(InntektType.LOENNSINNTEKT, InntektBeskrivelse.YRKEBIL_TJENESTLIGBEHOV_KILOMETER, null) to "Yrkesbil tjenestlig behov kilometer",
        DatagrunnlagKlassifisering(InntektType.LOENNSINNTEKT, InntektBeskrivelse.YRKEBIL_TJENESTLIGBEHOV_LISTEPRIS, null) to "Yrkesbil tjenestlig behov listepris",
        ...
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.DAGPENGER_VED_ARBEIDSLOESHET_FERIETILLEGG, null) to "Dagpenger ved arbeidsløshet - Ferietillegg",
        ...
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.DAGPENGER_TIL_FISKER_SOM_BARE_HAR_HYRE_FERIETILLEGG, null) to "Dagpenger til fisker som bare har hyre - Ferietillegg",
        ...
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.FORELDREPENGER_FERIEPENGER, null) to "Foreldrepenger fra folketrygden - Feriepenger",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OMSORGSPENGER, null) to "Omsorgspenger fra folketrygden",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OMSORGSPENGER_FERIEPENGER, null) to "Omsorgspenger fra folketrygden - Feriepenger",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OPPLÆRINGSPENGER, null) to "Opplæringspenger fra folketrygden",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OPPLÆRINGSPENGER_FERIEPENGER, null) to "Opplæringspenger fra folketrygden - Feriepenger",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.PLEIEPENGER, null) to "Pleiepenger fra folketrygden",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.PLEIEPENGER_FERIEPENGER, null) to "Pleiepenger fra folketrygden - Feriepenger",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.SVANGERSKAPSPENGER, null) to "Svangerskapspenger fra folketrygden",
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.SVANGERSKAPSPENGER_FERIEPENGER, null) to "Svangerskapspenger fra folketrygden - Feriepenger",
        ...
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.SYKEPENGER_FERIEPENGER, null) to "Sykepenger fra folketrygden - Feriepenger",
        ...
        DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.SYKEPENGER_TIL_FISKER_SOM_BARE_HAR_HYRE_FERIEPENGER, null) to "Sykepenger til fisker som bare har hyre - Feriepenger",
