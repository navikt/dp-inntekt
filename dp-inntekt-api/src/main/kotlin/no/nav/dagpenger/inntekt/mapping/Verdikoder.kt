...
val dataGrunnlagKlassifiseringToVerdikode = biMapOf(
    ...
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.DAGPENGER_VED_ARBEIDSLOESHET_FERIETILLEGG, null) to "Ferietillegg dagpenger ved arbeidsløshet",
    ...
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.DAGPENGER_TIL_FISKER_SOM_BARE_HAR_HYRE_FERIETILLEGG, null) to "Ferietillegg dagpenger til fisker som bare har hyre",
    ...
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.FORELDREPENGER_FERIEPENGER, null) to "Feriepenger foreldrepenger",
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OMSORGSPENGER, null) to "Omsorgspenger",
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OMSORGSPENGER_FERIEPENGER, null) to "Feriepenger omsorgspenger",
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OPPLÆRINGSPENGER, null) to "Opplæringspenger",
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.OPPLÆRINGSPENGER_FERIEPENGER, null) to "Feriepenger opplæringspenger",
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.PLEIEPENGER, null) to "Pleiepenger",
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.PLEIEPENGER_FERIEPENGER, null) to "Feriepenger pleiepenger",
    ...
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.SVANGERSKAPSPENGER_FERIEPENGER, null) to "Feriepenger svangerskapspenger",
    ...
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.SYKEPENGER_FERIEPENGER, null) to "Feriepenger sykepenger fra folketrygden",
    ...
    DatagrunnlagKlassifisering(InntektType.YTELSE_FRA_OFFENTLIGE, InntektBeskrivelse.SYKEPENGER_TIL_FISKER_SOM_BARE_HAR_HYRE_FERIEPENGER, null) to "Feriepenger sykepenger til fisker som bare har hyre",
